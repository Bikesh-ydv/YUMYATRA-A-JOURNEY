    ...
    return (!restaurantInfo) ? 
     ...
     : (
        ...
        duration: 1500,
            ...
            <div className="  sm:w-full md:w-full lg:w-full flex h-52 justify-center align-middle overflow-y-hidden bg-gray-500 text-cyan-50 ">
            <img 
            className="w-52 h-50 lg:w-80 md:w-80  "
            src= {IMG_CDN_URL+ restaurantInfo.cloudinaryImageId}></img>
            <div className="flex flex-col  w-[370px]">
              <h2 className=" text-2xl max-w-lg text-opacity-80">{restaurantInfo.name}</h2>
            ...
            <div className="my-[10px] w-[342px] md:w-[700px] lg:w-[850px] mx-auto sm:mx-auto md:mx-auto lg:mx-auto border-2 shadow-md pb-5 z-20 bg-green-400">
               ...
               { 
                  ...
                  <div className="flex flex-col mx-auto sm:mx-auto md:mx-auto lg:mx-auto mt-[5px] w-[342px] md:w-[700px] lg:w-[850px] text-center hover:shadow-md z-20  " key={item?.id}>
